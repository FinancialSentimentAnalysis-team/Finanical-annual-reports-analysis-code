...
def save_into_excel(result_path, stock, annual_pos, annual_neg, interim_pos, interim_neg):
    ...
    Positive_Annual = workbook.add_sheet("Positive_Annual")
    Negative_Annual = workbook.add_sheet("Negative_Annual")
    Positive_Interim = workbook.add_sheet("Positive_Interim")
    Negative_Interim = workbook.add_sheet("Negative_Interim")
    ...
    _write_summary(Summary, annual_pos, annual_neg, interim_pos, interim_neg)
    workbook.save(result_path + '/' + stock + '_summary.xls')
...
def _write_summary(sheet, annual_pos, annual_neg, interim_pos, interim_neg):
...
if __name__ == "__main__":
    ...
    result_path = "/usr/yyy/self testing/excel_summary/"
