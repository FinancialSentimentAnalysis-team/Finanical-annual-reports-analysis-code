...
if __name__ == '__main__':
    root_path = '/usr/yyy/wk4/Count_Weighted_Harvard/'
    result_path = '/usr/yyy/wk4/Summary_Weighted_Harvard/'
    ...
    for file_name in os.listdir(root_path):
        ...
        result_file_path = result_path + file_name[:5] +'_Harvard_weighted_summary.xls'        
