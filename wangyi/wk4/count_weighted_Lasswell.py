...
if __name__ == '__main__':
    ...
    result_path = '/usr/yyy/wk4/Count_Weighted_Lasswell/'
    dictionary_path = '/usr/yyy/dictionaries/Lasswell dictionary converted/'
    ...
    for file_name in os.listdir(root_path):
        ...
        result_file_path = result_path +file_name[:5]+ '_Lasswell_weighted_count.xls'
