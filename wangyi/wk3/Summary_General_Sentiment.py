...
if __name__ == '__main__':
    root_path = '/usr/yyy/wk3/Count_General_Sentiment/'
    result_path = '/usr/yyy/wk3/Summary_General_Sentiment/'
    ...
    for file_name in os.listdir(root_path):
        ...
        result_file_path = result_path + file_name[:5] + '_General_Sentiment_summary.xls'     
