...
if __name__ == '__main__':
    # Edit Area
    # ===================================================================   
    root_path = '/usr/yyy/wk5/Count_Weighted/'
    result_path = '/usr/yyy/wk5/Summary_Weighted/'
    ...
    for dictionary_name in dictionaries_names:
        ...
        for file_name in os.listdir(root_path_for_this_dictionary):
            ...
            result_file_path = result_path_for_this_dictionary + file_name[:5] +'_' + dictionary_name + '_weighted_summary.xls'        
