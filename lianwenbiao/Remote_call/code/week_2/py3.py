...
def treetager_stem(word_list):
    ret = []
    tagger = TreeTagger(TAGDIR="/home/lijunjie/lw/tool/TreeTagger", TAGPARFILE='/home/lijunjie/lw/tool/TreeTagger/english-utf8.par', TAGLANG='en')
    ...
    for word in word_list:
        ...
        if word.isdigit():
            ...
            tags = tagger.TagText(word.lower())
            for tag in tags:
...
def save_word_freq(w_freq, f_path, f_name):
    ...
    with open(f_path + f_name + '_treetagger.txt', "w") as txt_f:
...
if __name__ == '__main__':
    corpus_root = "/home/lijunjie/lw/data/filter_files/"
