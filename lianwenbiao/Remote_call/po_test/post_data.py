...
if os.path.isdir(path):
    ...
    os.system('bash post_data.sh ' + '"' + sys.argv[1].replace(' ', '\ ') + '" "' + sys.argv[2].replace(' ', '\ ') + '" "' + expect_str.replace(' ', '\ ') + '" "' + username + '" "' + userip + '" "' + password + '"') 

else:
    os.system('bash post_data.sh ' + '"' + sys.argv[1].replace(' ', '\ ') + '" "' + sys.argv[2].replace(' ', '\ ') + '" "100%" "' + username + '" "' + userip + '" "' + password + '"')
